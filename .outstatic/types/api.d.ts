...
interface LoadAPI {
  ...
  ): FindAPI<OutstaticSchema<NewsFields>, Pick<OutstaticSchema<NewsFields>, K>>

  /** Find news documents */
  find(
    query: { collection: 'news' } & Record<string, unknown>,
    projection: string[]
  ): FindAPI<OutstaticSchema<NewsFields>>
  ...
  /** Find pages documents with field projection (use 'as const' for type narrowing) */
  find<K extends keyof OutstaticSchema<PagesFields>>(
    query: { collection: 'pages' } & Record<string, unknown>,
    projection: readonly K[]
  ): FindAPI<OutstaticSchema<PagesFields>, Pick<OutstaticSchema<PagesFields>, K>>

  /** Find pages documents */
  find(
    query: { collection: 'pages' } & Record<string, unknown>,
    projection: string[]
  ): FindAPI<OutstaticSchema<PagesFields>>
